...
import { body, clinicsNotFound, deleteReturn, errorResponse, regionalNotFound, userId } from "./utils";
...
describe('ClinicsController', () => {
    ...
    describe('readOne', () => {
        it('deve retornar erro caso clínica nao exista', async () => {
            ...
            await expect(clinicsController.readOne(userId)).rejects.toEqual(clinicsNotFound);
    ...
    describe('update', () => {
        it('deve retornar erro caso clínica nao exista', async () => {
            ...
            await expect(clinicsController.update(body, userId)).rejects.toEqual(clinicsNotFound);
    ...
    describe('delete', () => {
        it('deve retornar erro caso clínica nao exista', async () => {
            ...
            await expect(clinicsController.delete(userId)).rejects.toEqual(clinicsNotFound);
